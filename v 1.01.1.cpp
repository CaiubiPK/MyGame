...
public:
	...
	void ExplicacaoGeral()
	{
		system("cls");
		tutoriais();
		ImprimirComDelayNoFim("\n\n\n\n\t\tSeja bem Vindo as Instruções de Combate\n");
	}
	void ExplicacaoItens()
	{
			...
			Rosa("\t\tMágicos ");cout<<"        -";   Rosa(" Rosa\n");
			Amarelo("\t\tLendários ");cout<<"      -";   Amarelo(" Amarelo\n");
			Vermelho("\t\tItens do Dragão ");cout<<"-";   Vermelho(" Vermelho\n");
			Pause();
	...
	void ExplicacaoCombate()
	{
		...
		Verde("\t\t\tHP (Health Points)"); cout <<" é a quantidade de vida do seu personagem,\n\t\t\tse chegar a 0 você é derrotado.";

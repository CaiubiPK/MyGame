...
public:
	...
	void ExplicacaoGeral()
	{
		system ("cls");
		tutoriais();
		VerdeCDNoFim("\n\tEste é um jogo desenvolvido inteiramente em C++.\n\n");
		ImprimirComDelay("\tCriar um joigo foi uma ideia que sempre me chamou a atenção, eno meu primeiro semestre\n");
		ImprimirComDelay("\tde faculdade, surgiu uma oportunidade, comoçei bem humildimente fazendo esse jogo, \n");
		ImprimirComDelay("\teram apenas menus com npumeros na cidade de greenwitch, começei a usar a função KBHIT, e fazer menus \n");
		...
		ImprimirComDelay("\tgastei hóras aprendendo a manipular cores pelo terminal, e fiz artes em ASCII usando cores, como a logo do jogo, \n");
		ImprimirComDelay("\t(por sinal foi bem trabalhoso desenhar 2 dragões pixel por pixel em um terminal)\n");
		ImprimirComDelayNoFim("\tnão havia sistema de combate e havia um pequeno sistema precário de itens.\n\n\n");
		ImprimirComDelay("\tNo segundo semestre da faculdade aprendi orientação programada a objetos, e criei um sistema de combate usando isso,\n");
		ImprimirComDelay("\tMuito tempo depois de aprimorar o sistema de combate, resolvi com muito ñimo e disposiçáo unificar meu antigo jogo e esse sistema de combate,\n");
		ImprimirComDelay("\to tRAbalho seria ridículo de grande, eu deveria transformar +- 2.800 linhas de código em orientação programada a objetos\n");
    ...
    PraiaSecreta(Jogador*jogador)
    {
        ...
        switch(Tecla())
        {
                ...
                case 49:
            		while(1)
					{
            			ImprimirComDelay("\tA mulher lhe olha com uma feição doçe e tênue, enquanto fala, ó ceu se curva perante a sua beleza");RosaCD("Praia Secreta");ImprimirComDelayNoFim(".\n");
			            ImprimirComDelay("\tÉ possível ouvir apenas as ondas do mar, trazendo sensações relaxantes e serenas.\n"); 
			            ImprimirComDelay("\tHá uma mulher em meio a praia, com sua pele morena brilhando sob o céu,\n"); 
						ImprimirComDelay("e trajando um longo vestido branco.\n"); 
						ImprimirComDelay("\tO que irá fazer ");ImprimirComDelay(jogador->getnome());ImprimirComDelayNoFim("?\n");	
